...
static void JavaCPP_com_myntra_appscore_reakt_generated_NativeLibrary_00024NativeClass_deallocate(void *p) { delete (::NativeLibrary::NativeClass*)p; }
static void JavaCPP_com_myntra_appscore_reakt_generated_NativeLibrary_00024NativeClass_deallocateArray(void* p) { delete[] (::NativeLibrary::NativeClass*)p; }

static const char* JavaCPP_members[11][3] = {
        { NULL },
        { NULL },
        { NULL },
        { NULL },
...
JNIEXPORT void JNICALL Java_com_myntra_appscore_reakt_generated_NativeLibrary_00024NativeClass_allocate(JNIEnv* env, jobject obj) {
    ...
    try {
        ...
        jlong rcapacity = 1;
        JavaCPP_initPointer(env, obj, rptr, rcapacity, rptr, &JavaCPP_com_myntra_appscore_reakt_generated_NativeLibrary_00024NativeClass_deallocate);
    } catch (...) {
